...
<div class="row">
    <div class="col-md-12">
       <div class="card">
          <div class="card-body">
             <form action="{{route('thajar.store')}}" method="POST" role="alert">
                @csrf
                <!-- title -->
                ...
                <div class="form-group">
                    ...
                    <input  value="{{old('tahun')}}" name="tahun" type="text" class="form-control @error('tahun') is-invalid @enderror" placeholder="enter tahun ajar"/>
                    @error('tahun')
