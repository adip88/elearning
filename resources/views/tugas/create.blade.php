          ...
          <div class="card-body">
             <form action="{{route('tugas.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="judul" id="" cols="30" rows="10" class="form-control @error('judul') is-invalid @enderror" required >{{old('tugas')}}</textarea>
                    @error('judul')
                ...
                <div class="form-group">
                    ...
                    <textarea name="tugas" id="" cols="30" rows="10" class="form-control @error('tugas') is-invalid @enderror" required >{{old('tugas')}}</textarea>
                    @error('tugas')
                        <div class="invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
                ...
                {{-- <div class="form-group">
                    <label for="input_name" class="font-weight-bold">Tipe Jawaban</label>
                    <select name="tipe" id="" class="form-control @error('tipe') is-invalid @enderror">
                        <option value="1">Jawaban Berupa file</option>
                        <option value="2">Jawaban Berupa text singkat</option>
                    </select>
                    @error('tipe')
                        <div class="invalid-feedback">{{$message}}</div>
                    @enderror
